    ...
    const exports = [
        {
            ...
            icon: Sparkles,
            endpoint: "/master-plan",
            filename: "startup_master_plan.md",
                ...
                {exports.map((item, index) => {
                    ...
                    return (
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            className={cn(
                                "block w-full text-left relative group rounded-xl transition-all duration-300",
                                item.featured && "mb-3"
                            )}
                        >
